...
const start = async () => {
  ...
  const dropNumber = async (context) => {
    ...
    //console.clear();
      ...
      console.clear();
      console.log(gradient('blue', 'white')('BY Descodia X King +' + ddi + number))
  ...
  console.log(gradient('black', 'black')('■'))
  console.log(gradient('black', 'black')('■'))
  let ddi = prompt(gradient('blue', 'white')('[+] Descodia X King >>Enter the country code: '));
  let number = prompt(gradient('blue', 'white')('[+] enter your number: '))
